        ...
        >
          ...
          >
            <motion.a
              ...
              whileTap={{ scale: 0.95 }}
              className="px-8 py-3.5 bg-foreground text-background font-mono text-xs uppercase tracking-[0.1em] rounded-sm hover:bg-foreground/85 transition-all"
            >
              View My Work
            </motion.a>
            <motion.a
              ...
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="px-8 py-3.5 border border-border text-foreground font-mono text-xs uppercase tracking-[0.1em] rounded-sm hover:border-electric/50 hover:text-electric transition-all"
            >
              Contact Me
            </motion.a>
          </motion.div>
